...
const QUERIES = {
  ...
  arq_etf:      { q: "ARKQ ARK Autonomous Technology Robotics ETF" },
...
const STATIC_ANALYSIS = {
  ...
  arq_etf:      "ARK Autonomous Technology & Robotics ETF — 자율주행/로보틱스/3D프린팅 테마. Tesla·Trimble·Kratos 비중. 혁신 테마라 변동성 큼.",
